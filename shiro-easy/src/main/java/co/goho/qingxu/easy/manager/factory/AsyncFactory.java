package co.goho.qingxu.easy.manager.factory;
...
import co.goho.qingxu.easy.conmmon.utils.AddressUtils;
...
import co.goho.qingxu.easy.service.impl.SysLogininfoServiceImpl;
import co.goho.qingxu.easy.shiro.session.OnlineSession;
import co.goho.qingxu.easy.web.util.LogUtils;
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session) {
        return new TimerTask() {
            ...
            public void run() {
                ...
                online.setOnlineStatus(session.getOnlineStatus());
                SpringUtils.getBean(SysUserOnlineService.class).save(online);
            }
        };
    }
