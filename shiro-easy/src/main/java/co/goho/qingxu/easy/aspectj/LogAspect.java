...
import co.goho.qingxu.easy.conmmon.annotation.Log;
import co.goho.qingxu.easy.conmmon.enums.BusinessStatus;
import co.goho.qingxu.easy.conmmon.utils.ServletUtils;
import co.goho.qingxu.easy.conmmon.utils.StringUtils;
import co.goho.qingxu.easy.conmmon.utils.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(co.goho.qingxu.easy.conmmon.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setOperStatus(String.valueOf(BusinessStatus.SUCCESS.ordinal()));
            // 请求的地址
            ...
            if (e != null) {
                operLog.setOperStatus(String.valueOf(BusinessStatus.FAIL.ordinal()));
