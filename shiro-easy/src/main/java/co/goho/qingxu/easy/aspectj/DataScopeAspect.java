...
import co.goho.qingxu.easy.conmmon.annotation.DataScope;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(co.goho.qingxu.easy.conmmon.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias) {
        ...
        for (SysRole role : user.getRoles()) {
            ...
            if (DATA_SCOPE_ALL.equals(dataScope)) {
                ...
                sqlString.append(StringUtils.format(" OR {}.dept_id = ( SELECT dept_id FROM sys_role WHERE id = {} ) ", deptAlias, role.getId()));
